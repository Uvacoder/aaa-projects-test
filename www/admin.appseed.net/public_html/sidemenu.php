...
<ul class="nav">
     <center><a href="/1/dashboard.php"><img src="/assets/img/logo.png" class="title profile-picture-small"></a></center>
        ...
        <li><a href="/1/dashboard.php"><span class="ion-ios-home-outline fa-fw"></span> Dashboard</a></li>
        <li><a href="#news"><span class="ion-social-usd-outline fa-fw"></span> Sales</a></li>
        <li><a href="/1/team.php"><span class="ion-ios-people-outline fa-fw"></span> Team</a></li>
    ...
    <li><a href="/1/plugins/plugins.php"><span class="fa-fw ion-ios-infinite-outline"></span> Plugins</a></li>
    <li><a href="#about"><span class="ion-ios-star-outline fa-fw"></span> Reviews</a></li>
            <a class="title">App Settings</a>
        <li><a href="/1/backups.php"><span class="ion-ios-cloud-outline fa-fw"></span> Backups</a></li>
        <li><a href="/1/settings.php"><span class="ion-ios-gear-outline fa-fw"></span> Settings</a></li>
    </ul>
<script>
function demo() {
