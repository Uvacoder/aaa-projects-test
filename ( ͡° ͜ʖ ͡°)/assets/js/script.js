$(function () {
    ...
    $(".mobile-toggle-container").click(function () {
        if ($(".nav").attr("class") === "nav") {
            ...
            $("#mob_menu").attr("class", "nav-mobile-container nav-mobile-container-default nav-mobile-container-visible");
        } else {
            $(".nav").attr("class", "nav");
            $(".mobile-toggle-container").attr("class", "mobile-toggle-container");
            $("#mob_menu").attr("class", "nav-mobile-container nav-mobile-container--default");
        }
    });
