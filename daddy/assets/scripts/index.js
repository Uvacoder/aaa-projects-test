$(document).ready(function () {
    ...
    function homepage_fullpage() {
        ...
        $('#homepage-fullpage').fullpage({
            ...
            sectionsColor: ['#F7F9FA', '#F7F9FA', '#F7F9FA', '#F7F9FA', '#F7F9FA', '#F7F9FA'],
            paddingTop: '0em',
            paddingBottom: '0em',
...
$(".icon-menu-open").click(function () {
    ...
    $(".nav-appear").css("transform", "translateX(70px)");
});
$(".icon-menu-close").click(function () {
    $(this).css("display", "none");
    $(".logo").css("opacity", "1");
    $(".icon-menu-open").css("display", "block");
    $(".nav-appear").css("transform", "translateX(-100%)");
});
...
$(document).ready(function () {
    ...
    $('.menu-burger').click(function () {
        ...
        $('.overlay').fadeToggle(0, 'linear'); // toggles open the nav overlay // Optionally could change fadeIn & fadeut to both toggleClass
        $('.menu-options-list').delay(0).addClass('slideDownIn'); // Rapidly fades option in upward into place
    });
});
