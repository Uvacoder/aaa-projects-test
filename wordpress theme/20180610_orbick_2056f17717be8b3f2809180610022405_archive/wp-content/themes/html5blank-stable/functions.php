...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('small', 300, 200, true); // Small Thumbnail
...
// Remove Actions
remove_action('wp_head', 'feed_links_extra', 12); // Display the links to the extra feeds such as category feeds
...
function special_nav_class ($classes, $item) {
    if (in_array('nav-list-link', $classes) ){
        $classes[] = 'active ';
    }
    return $classes;
}
