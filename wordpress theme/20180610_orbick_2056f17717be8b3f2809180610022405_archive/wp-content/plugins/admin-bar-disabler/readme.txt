...
Please note: The name "Admin Bar" was changed to be called "Toolbar" after the initial WordPress feature release, but the usage in this plugin remains the same.
